...
export interface ProductConfig {
    meta: ProductMeta;
    components: {
        [componentCode: string]: ComponentConfig;
    };
    ui: UIStructure[];
    layouts: any;
}
...
export interface MaterialConfig {
    ...
    shader?: {
        [materialId: string]: ShaderConfig;
    };
}
...
export interface ProductLibrary {
    colors: {
        [colorId: string]: LibraryColor;
    };
    materials?: {
        [materialId: string]: LibraryMaterial;
    };
    prints?: {
        [printId: string]: LibraryPrint;
    };
    decals?: {
        [decalId: string]: LibraryDecal;
    };
    fonts?: {
        [fontId: string]: LibraryFont;
    };
}
