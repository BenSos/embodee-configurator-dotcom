 ...
 */
export const ConfiguratorError = ({ error, isRetrying, retryCount, onRetry, className = '' }) => {
    if (!error) {
        return null;
    }
    ...
    return (_jsx("div", { className: `flex flex-col items-center justify-center min-h-[400px] p-6 text-center ${className}`, children: _jsxs("div", { className: "max-w-md", children: [_jsx("div", { className: "mb-4", children: getErrorIcon() }), _jsx("h2", { className: "text-xl font-semibold text-gray-900 mb-2", children: getErrorTitle() }), _jsx("p", { className: "text-gray-600 mb-4", children: getErrorDescription() }), _jsx("div", { className: "text-sm text-gray-500 mb-4", children: getErrorMessage() }), _jsxs("div", { className: "space-x-3", children: [!isRetrying && (_jsx("button", { onClick: onRetry, className: "px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2", children: "Try Again" })), _jsx("button", { onClick: () => window.location.reload(), className: "px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2", children: "Refresh Page" })] })] }) }));
};
